...
class OsDeceiver:
    def __init__(self, target_host: str, target_os: str, dest=None, nic=None):
        ...
        logging.info(f"OS Deception ready for {self.os} using path: {self.os_record_path} on NIC: {self.nic}")
